    ...
    Swal.fire({
        ...
        if (result.value) {
            Swal.fire({
                ...
                text: "Kết bạn Zalo với mình nhá Sđt:0384208001 :v Còn giờ thì chờ gì nữa mà ko inbox cho tớ đi nàoooooo",
                confirmButtonColor: '#83d0c9',
                onClose: () => {
                    window.location = 'https://www.facebook.com/hieu.nguyengia.98';
                  }
            })
        }
    })
